package base.effects
{
	...
	public class NEffectTweener
	{
		...
		// ============================================================
		private static var Pool:NObjectsPool = new NObjectsPool( MAX_TWEEN_OBJECTS, NEffectTweener );
		...
		// ============================================================
		public function NEffectTweener()	// объекты для NObjectsPool должны иметь "пустой" конструктор
		{
		}
		// ============================================================
		public function Init( target:*, duration:Number, vars:*, extra_vars:Array ):NEffectTweener
		{
		...
		// ============================================================
		public static function to( target:*, duration:Number, vars:*, extra_vars:Array = null ):NEffectTweener
		{
			return NEffectTweener(Pool.Obj).Init( target, duration, vars, extra_vars );
		}
		// ============================================================
		...
		public static function Quant( diff_ms:int ):void
		{
			...
			var a:Dictionary = AllTweens, p:NEffectTweener, tw:Object;
			for each (p in a)
			{
				//trace( "NTweener:", p );
		...
		// ============================================================
		public static function removeTween(t:NEffectTweener = null):void
		{
